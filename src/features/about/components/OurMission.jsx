    ...
    <section className="py-10 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        <div className="bg-white border border-gray-100 shadow-sm rounded-[2rem] p-12 md:p-15 text-center transition-all hover:shadow-md">
          <h2 style={{ color: 'black' }} className="text-4xl font-bold font-serif mb-8">Our Mission</h2>
          <p className="text-gray-500 text-xl md:text-2xl leading-relaxed max-w-4xl mx-auto font-light font-serif mb-8">
