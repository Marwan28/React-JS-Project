    ...
    <section className='py-6 px-6 md:px-12 lg:px-24 bg-white'>
      <div className='max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center'>
        <div className='order-2 md:order-1'>
          <h2 className='text-4xl font-bold text-[#1a1a1a] mb-6 font-serif mb-8'>Our Story</h2>
        </div>
  
            <div className="space-y-6 text-gray-600 text-lg leading-relaxed font-serif mb-8">
              <p>
