...
function ProfileSidebar({ isEditing, setIsEditing, refreshKey }) {
  ...
  return (
    <div className="mx-auto h-fit w-full max-w-sm rounded-2xl border border-gray-100 bg-white p-6 text-center font-sans shadow-sm dark:border-slate-800 dark:bg-slate-900">
